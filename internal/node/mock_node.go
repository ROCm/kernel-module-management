...
func (m *MockNode) GetNodesListBySelector(ctx context.Context, selector map[string]string, tolerations []v1.Toleration, ignoreTaint bool) ([]v1.Node, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodesListBySelector", ctx, selector, tolerations, ignoreTaint)
...
func (mr *MockNodeMockRecorder) GetNodesListBySelector(ctx, selector, tolerations, ignoreTaint any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodesListBySelector", reflect.TypeOf((*MockNode)(nil).GetNodesListBySelector), ctx, selector, tolerations, ignoreTaint)
}
