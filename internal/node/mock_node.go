...
func (m *MockNode) GetNodesListBySelector(ctx context.Context, selector map[string]string, ignoreTaint bool) ([]v1.Node, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodesListBySelector", ctx, selector, ignoreTaint)
...
func (mr *MockNodeMockRecorder) GetNodesListBySelector(ctx, selector, ignoreTaint any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodesListBySelector", reflect.TypeOf((*MockNode)(nil).GetNodesListBySelector), ctx, selector, ignoreTaint)
}
