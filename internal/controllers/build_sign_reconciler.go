...
func (r *BuildSignReconciler) Reconcile(ctx context.Context, mod *kmmv1beta1.Module) (ctrl.Result, error) {
	...
	targetedNodes, err := r.nodeAPI.GetNodesListBySelector(ctx, mod.Spec.Selector, mod.Spec.Tolerations, r.reconHelperAPI.shouldIgnoreTaint(mod))
	if err != nil {
...
func (bsrh *buildSignReconcilerHelper) shouldIgnoreTaint(mod *kmmv1beta1.Module) bool {
