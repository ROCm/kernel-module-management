...
func (m *MockbuildSignReconcilerHelperAPI) shouldIgnoreTaint(mod *v1beta1.Module) bool {
	m.ctrl.T.Helper()
...
func (mr *MockbuildSignReconcilerHelperAPIMockRecorder) shouldIgnoreTaint(mod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "shouldIgnoreTaint", reflect.TypeOf((*MockbuildSignReconcilerHelperAPI)(nil).shouldIgnoreTaint), mod)
}
