...
// shouldIgnoreTaint mocks base method.
func (m *MockmoduleNMCReconcilerHelperAPI) shouldIgnoreTaint(mod *v1beta1.Module) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "shouldIgnoreTaint", mod)
	ret0, _ := ret[0].(bool)
	return ret0
}

// shouldIgnoreTaint indicates an expected call of shouldIgnoreTaint.
func (mr *MockmoduleNMCReconcilerHelperAPIMockRecorder) shouldIgnoreTaint(mod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "shouldIgnoreTaint", reflect.TypeOf((*MockmoduleNMCReconcilerHelperAPI)(nil).shouldIgnoreTaint), mod)
}
